(() => {
  ...
  async function seed(){
    if(!window.LOOP_CONFIG || !window.supabase) return;
    ...
    for(const d of drafts){
      ...
      await db.from('loop_events').insert({name:d[0],category:d[1],event_date:d[2],event_time:d[3],ticket_url:d[4],price:"I don't know",postcode:'TBC',added_by:'BT'});
    }
  }
  setTimeout(seed, 1800);
})();